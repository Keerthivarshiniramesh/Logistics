...
//                         <li className={`p-2  m-5 ${change === 'Home' && 'format'}`} ><div className='select1'><i className="bi bi-house-fill text-success mx-1 fs-3 " onClick={(e) => Change(e, 'Home')}></i>Home</div></li>
...
//                                     <button className="card-text text-center w-50 btn rounded fw-bold btn-success" onClick={() => use('/trip_details')}>Trip...</button>
//                                 </div>
//                             </div>
//                         </div>
...
export default function Home() {
    ...
    function Change(e, values) {
        ...
        setTimeout(() => {
            if (values === "Home") navigate("/dashboard");
            else if (values === "Vehicle") navigate("/vehicle-details");
            else if (values === "Employee") navigate("/employee_details");
            else if (values === "Trip") navigate("/trip_details");
        }, 200);
    }
                        ...
                        <div className="col">
                            <div className="card">
                                ...
                                <div className="card-body text-center bg-light">
                                    <h5 className="card-title">Vehicle</h5>
                                    <button
                                        className="card-text text-center w-50 btn rounded fw-bold btn-success"
